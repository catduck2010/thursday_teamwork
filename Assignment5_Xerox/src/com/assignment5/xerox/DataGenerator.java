...
public class DataGenerator {
    private Map<Integer, Product> productCatalogue;
    ...
    public static final String NEW_PROD_CAT_PATH= "./ModifiedProductCatalogue.csv";
    ...
    private int randomSalesPriceForProductId(int id){
        Product prod = productCatalogue.get(id);        
        return prod.getMin() + rand.nextInt(prod.getMax() - prod.getMin());
    }
    ...
    private void generateProductsColumns() throws IOException{
        ...
        while(productId < productIdsRange){
            ...
            productCatalogue.put(productId, new Product(minPrice, maxPrice, targetPrice));
